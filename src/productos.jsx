...
const ProductInterface = () => {
  ...
  const elementTypes = [
    { name: 'Material', placeholderText: 'Ingresa el nuevo material' },
    { name: 'Acabado', placeholderText: 'Describe el nuevo acabado' },
    { name: 'Peso', placeholderText: 'Ingresa el nuevo peso' }
  ];
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg w-[500px] p-6 relative">
            <button
              className="absolute top-4 right-4 text-black hover:text-base"
